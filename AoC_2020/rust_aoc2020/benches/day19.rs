...
pub fn criterion_benchmark(c: &mut Criterion) {
    ...
    c.bench_function("day 19 load input for part one", |b| b.iter(|| load_input("input_1")));
    c.bench_function("day 19 part one", |b| b.iter(|| one(&input_1)));
    c.bench_function("day 19 load input for part two", |b| b.iter(|| load_input("input_2")));
